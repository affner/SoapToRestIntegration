...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("http://tic.play.es/consumed/WS_RECEP_SOL", "Document");
    private final static QName _Output_QNAME = new QName("http://tic.play.es/consumed/WS_RECEP_SOL", "Output");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tic.play.es/consumed/WS_RECEP_SOL", name = "Document")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tic.play.es/consumed/WS_RECEP_SOL", name = "Output")
